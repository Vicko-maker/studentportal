...
from .models import Notes, Homeworks, Todo
from .forms import (NotesForm, HomeworkForm, DashboardForm, TodoForm, ConversionForm,
                    ConversionLengthForm, ConversionMassForm, UserRegistrationForm)
